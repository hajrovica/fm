...
<?php
    $meta = array(
        ...
        array('name' => 'description', 'content' => 'Fiskalni monitor BiH'),
        array('name' => 'keywords', 'content' => 'fiskalni, monitor, BiH, prihodi, rashodi, gradovi, opštine, potrošnja, prati, provjeri'),
        array('name' => 'robots', 'content' => 'no-cache'),
